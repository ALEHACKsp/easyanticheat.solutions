...
//			}
//			catch (CryptoPP::Exception& ex) {
//				MessageBoxA(0, c_xor("Invalid API/Encryption key"), "cAuth", MB_ICONERROR);
//				exit(0);
//			}
//			return plain_text;
//		}
...
//				MessageBoxA(0, c_xor("The program key you tried to use doesn't exist"), "cAuth", MB_ICONERROR);
//
//				return;
//			}
//
...
//				MessageBoxA(0, std::string(decoded_response[c_xor("message")]).c_str(), "cAuth", MB_ICONERROR);
//
...
//
//			if (!is_initialized) {
//				MessageBoxA(0, c_xor("The program wasn't initialized"), "cAuth", MB_ICONERROR);
//
//				return false;
//			}
//
...
//
//			if (!logged_in) {
//				MessageBoxA(0, c_xor("You can only grab server sided variables after being logged in."), "cAuth", MB_ICONERROR);
//
...
//
//			curl_easy_setopt(c_url, CURLOPT_PINNEDPUBLICKEY, c_xor("sha256//Mk6vhbkCoRzUhXoUryC8tjIxmehtu4uLVhwqGQM9Cmc="));
//
